...
// Note:    This file works in conjunction with logger.js to log constious events that occur when using these APIs
//  Dependencies:
//      NodeJS v8.9.1
'use strict'
    ...
    http
      .get(options, function (response) {
        ...
        response.on('end', function () {
          logger.log(
            `Response ended with code ${response.statusCode}...`,
            loggerOptions
          )
