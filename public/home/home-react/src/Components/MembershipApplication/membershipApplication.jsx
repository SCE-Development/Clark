                ...
                </div>
                {
                    ...
                    <Form class="page-form">
                        ...
                        <FormGroup>
                            ...
                            <Input type="password" onChange={this.mutatePassword.bind(this)} value={this.state.password} name="password" id="input_password" placeholder="(e.g. sce_password)"></Input>
                        </FormGroup>
                        <FormGroup>
                            <Label for="major">Major</Label>
                            <Input type="text" onChange={this.mutateMajor.bind(this)} value={this.state.major}></Input>
                        </FormGroup>
