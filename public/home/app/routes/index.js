...
//     const validResult = typeof existingSession === 'object' && typeof existingSession.maxIdleTime === 'number' && typeof existingSession.lastActivity === 'string'
//     const lastActiveTimestamp = new Date((validResult) ? existingSession.lastActivity : Date.now())
//
