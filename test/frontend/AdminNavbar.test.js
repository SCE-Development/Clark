...
describe('<AdminNavbar />', () => {
  ...
  it('Should render 9 <NavLink /> tags with officer Credentials', () => {
    const wrapper = mount(<AdminNavbar />);
    expect(wrapper.find(NavLink)).to.have.lengthOf(9);
  });
  it('Should render 9 <NavLink /> tags with admin Credentials', () => {
