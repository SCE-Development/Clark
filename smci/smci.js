...
//  Details:
//      The Sce Mail Chimp Interface (SMCI). This file contains JavaScript wrapper functions for the MailChimp v3.0 APIs, which handle communication and control over the associated MailChimp account's mailing system, email campaign/subscriber lists, and constious other preferences.
...
/*
 ...
 @parameter  callback - a callback function to run after the request is issued. It is passed two arguments:
    ...
    The values of the "error" and "response" arguments consty depending on the result of the request.
...
smci.api.getRoot = function (qsObj, callback) {
  const handlerTag = { src: 'smci/api.getRoot' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.api.ping = function (callback) {
  const handlerTag = { src: 'smci/api.ping' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/ping`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.authorizedApps.register = function (requestBody, callback) {
  const handlerTag = { src: 'smci/authorizedApps.register' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/authorized-apps`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
...
smci.authorizedApps.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/authorizedApps.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/authorized-apps${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.authorizedApps.getAppInfo = function (appID, qsObj, callback) {
  const handlerTag = { src: 'smci/authorizedApps.getAppInfo' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/authorized-apps/${appID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.automations.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/automations.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.automations.getInfo = function (automationID, qsObj, callback) {
  const handlerTag = { src: 'smci/automations.getInfo' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.automations.pause = function (automationID, callback) {
  const handlerTag = { src: 'smci/automations.pause' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/actions/pause-all-emails`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json'
...
smci.automations.start = function (automationID, callback) {
  const handlerTag = { src: 'smci/automations.start' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/actions/start-all-emails`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json'
...
smci.automations.getEmails = function (automationID, callback) {
  const handlerTag = { src: 'smci/automations.getEmails' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.automations.getEmailInfo = function (automationID, emailID, callback) {
  const handlerTag = { src: 'smci/automations.getEmailInfo' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.automations.deleteEmail = function (automationID, emailID, callback) {
  const handlerTag = { src: 'smci/automations.deleteEmail' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}`,
    method: 'DELETE',
...
smci.automations.pauseEmail = function (automationID, emailID, callback) {
  const handlerTag = { src: 'smci/automations.pauseEmail' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}/actions/pause`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json'
...
smci.automations.startEmail = function (automationID, emailID, callback) {
  const handlerTag = { src: 'smci/automations.startEmail' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}/actions/start`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json'
...
*/
smci.automations.subscribeToEmail = function (
  automationID,
  emailID,
  recipient,
  callback
) {
  const handlerTag = { src: 'smci/automations.subscribeToEmail' }
  const requestBody = {
    email_address: recipient
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}/queue`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.automations.getEmailQueue = function (automationID, emailID, callback) {
  const handlerTag = { src: 'smci/automations.getEmailQueue' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}/queue`,
    method: 'GET',
...
*/
smci.automations.getEmailSubscriber = function (
  automationID,
  emailID,
  subscriberHash,
  callback
) {
  const handlerTag = { src: 'smci/automations.getEmailSubscriber' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/emails/${emailID}/queue/${subscriberHash}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
*/
smci.automations.blacklistSubscriber = function (
  automationID,
  recipient,
  callback
) {
  const handlerTag = { src: 'smci/automations.blacklistSubscriber' }
  const requestBody = {
    email_address: recipient
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/removed-subscribers`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.automations.getBlacklist = function (automationID, callback) {
  const handlerTag = { src: 'smci/automations.getBlacklist' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/automations/${automationID}/removed-subscribers`,
    method: 'GET',
...
smci.batchOps.add = function (requestBody, callback) {
  const handlerTag = { src: 'smci/batchOps.add' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/batches`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.batchOps.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/batchOps.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/batches${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.batchOps.getStatus = function (batchID, qsObj, callback) {
  const handlerTag = { src: 'smci/batchOps.getStatus' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/batches/${batchID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.batchOps.delete = function (batchID, callback) {
  const handlerTag = { src: 'smci/batchOps.delete' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/batches/${batchID}`,
    method: 'DELETE',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaignFolders.createFolder = function (folderName, callback) {
  const handlerTag = { src: 'smci/campaignFolders.createFolder' }
  const requestBody = {
    name: folderName
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaign-folders`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaignFolders.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/campaignFolders.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaign-folders${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaignFolders.getFolder = function (folderID, qsObj, callback) {
  const handlerTag = { src: 'smci/campaignFolders.getFolder' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaign-folders/${folderID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaignFolders.editFolder = function (folderID, newName, callback) {
  const handlerTag = { src: 'smci/campaignFolders.editFolder' }
  const requestBody = {
    name: newName
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaign-folders/${folderID}`,
    method: 'PATCH',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaignFolders.deleteFolder = function (folderID, callback) {
  const handlerTag = { src: 'smci/campaignFolders.deleteFolder' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaign-folders/${folderID}`,
    method: 'DELETE',
...
smci.campaigns.create = function (requestBody, callback) {
  const handlerTag = { src: 'smci/campaigns.create' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
*/
smci.campaigns.setCampaignContent = function (
  campaignID,
  requestBody,
  callback
) {
  const handlerTag = { src: 'smci/campaigns.setCampaignContent' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/content`,
    method: 'PUT',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/campaigns.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaigns.getCampaignInfo = function (campaignID, qsObj, callback) {
  const handlerTag = { src: 'smci/campaigns.getCampaignInfo' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaigns.editCampaignInfo = function (campaignID, requestBody, callback) {
  const handlerTag = { src: 'smci/campaigns.editCampaignInfo' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}`,
    method: 'PATCH',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.deleteCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.deleteCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}`,
    method: 'DELETE',
...
smci.campaigns.pauseCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.pauseCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/pause`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.copyCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.copyCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/replicate`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.resumeCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.resumeCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/resume`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.scheduleCampaign = function (campaignID, requestBody, callback) {
  const handlerTag = { src: 'smci/campaigns.scheduleCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/schedule`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.sendCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.sendCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/send`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.sendTestEmail = function (campaignID, requestBody, callback) {
  const handlerTag = { src: 'smci/campaigns.sendTestEmail' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/test`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.unscheduleCampaign = function (campaignID, callback) {
  const handlerTag = { src: 'smci/campaigns.unscheduleCampaign' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/actions/unschedule`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.campaigns.getChecklist = function (campaignID, qsObj, callback) {
  const handlerTag = { src: 'smci/campaigns.getChecklist' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/campaigns/${campaignID}/send-checklist${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.campaigns.search = function (qsObj, callback) {
  const handlerTag = { src: 'smci/campaigns.search' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/search-campaigns${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.lists.createList = function (requestBody, callback) {
  const handlerTag = { src: 'smci/lists.createList' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.lists.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/lists.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.lists.batchListMembers = function (listID, requestBody, callback) {
  const handlerTag = { src: 'smci/lists.batchListMembers' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.lists.getListInfo = function (listID, qsObj, callback) {
  const handlerTag = { src: 'smci/lists.getListInfo' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.lists.editListSettings = function (listID, requestBody, callback) {
  const handlerTag = { src: 'smci/lists.editListSettings' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}`,
    method: 'PATCH',
...
smci.lists.deleteList = function (listID, callback) {
  const handlerTag = { src: 'smci/lists.deleteList' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}`,
    method: 'DELETE',
...
smci.lists.addListMember = function (listID, requestBody, callback) {
  const handlerTag = { src: 'smci/lists.addListMember' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}/members`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.lists.getListMembers = function (listID, qsObj, callback) {
  const handlerTag = { src: 'smci/lists.getListMembers' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}/members${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
*/
smci.lists.editListMember = function (
  listID,
  subscriberID,
  requestBody,
  callback
) {
  const handlerTag = { src: 'smci/lists.editListMember' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}/members/${subscriberID}`,
    method: 'PATCH',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.lists.removeListMember = function (listID, subscriberID, callback) {
  const handlerTag = { src: 'smci/lists.removeListMember' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/lists/${listID}/members/${subscriberID}`,
    method: 'DELETE',
...
smci.lists.searchMembers = function (qsObj, callback) {
  const handlerTag = { src: 'smci/lists.searchMembers' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/search-members${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.templateFolders.createFolder = function (folderName, callback) {
  const handlerTag = { src: 'smci/templateFolders.createFolder' }
  const requestBody = {
    name: folderName
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/template-folders`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.templateFolders.deleteFolder = function (folderID, callback) {
  const handlerTag = { src: 'smci/templateFolders.deleteFolder' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/template-folders/${folderID}`,
    method: 'DELETE',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.templateFolders.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/templateFolders.getFullList' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/template-folders/`,
    method: 'GET',
...
smci.templateFolders.getFolder = function (folderID, qsObj, callback) {
  const handlerTag = { src: 'smci/templateFolders.getFolder' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/template-folders/${folderID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.templateFolders.editFolder = function (folderID, newName, callback) {
  const handlerTag = { src: 'smci/templateFolders.editFolder' }
  const requestBody = {
    name: newName
  }
  const options = {
...
*/
smci.templates.createTemplate = function (
  templateName,
  folderID,
  content,
  callback
) {
  const handlerTag = { src: 'smci/templates.createTemplate' }
  const requestBody = {
    name: templateName,
    html: content
  }
  ...
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/templates`,
    method: 'POST',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.templates.getFullList = function (qsObj, callback) {
  const handlerTag = { src: 'smci/templates.getFullList' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/templates${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.templates.getTemplateInfo = function (templateID, qsObj, callback) {
  const handlerTag = { src: 'smci/templates.getTemplateInfo' }
  const querystring = qsObj === null ? '' : `?${qs.stringify(qsObj)}`
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/templates/${templateID}${querystring}`,
    method: 'GET',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`
  }
...
smci.templates.editTemplateName = function (templateID, newName, callback) {
  const handlerTag = { src: 'smci/templates.editTemplateName' }
  const requestBody = {
    name: newName
  }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/templates/${templateID}`,
    method: 'PATCH',
    auth: `${smciSettings.anystring}:${smciSettings.apikey}`,
    headers: {
      'Content-Type': 'application/json',
...
smci.templates.editTemplateContent = function (templateID, newHtml, callback) {
  const handlerTag = { src: 'smci/templates.editTemplateContent' }
  const requestBody = {
    html: newHtml
  }
  const options = {
...
smci.templates.moveTemplate = function (templateID, newFolderID, callback) {
  const handlerTag = { src: 'smci/templates.moveTemplate' }
  const requestBody = {
...
smci.templates.deleteTemplate = function (templateID, callback) {
  const handlerTag = { src: 'smci/templates.deleteTemplate' }
  const options = {
    hostname: `${smciSettings.apiDataCenter}.api.mailchimp.com`,
    path: `/${smciSettings.apiVersion}/templates/${templateID}`,
    method: 'DELETE',
