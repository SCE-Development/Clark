...
angular.module('officertools').component('officertools', {
  ...
  controller: function ($http, $window) {
    ...
    var urls = {
      ...
      officerTraining:
        'https://drive.google.com/open?id=0B4BheoHJ1lZVZ1VZNUxJVE4xRm8',
      lockerSpreadsheet:
        'https://docs.google.com/spreadsheets/d/1oJwqrKhh2XXOJiyq0De10DJvdBHFsegZ7OmAgI5uSIQ/edit#gid=1312223330',
      dreamsparkSpreadsheet:
        'https://docs.google.com/spreadsheets/d/1SvtXBSY5wMtHmuUTDMGFIOS1BTviAm1O4dmBm94xCK8/edit',
      eodProfitForm: 'https://goo.gl/vcBWma',
      cashCountProcedures: 'https://www.goo.gl/kA8yTE',
      storeSlideshow:
        'https://docs.google.com/presentation/d/1iRopCuN8qT0e_easSX0t6StIwvqul-OgHZpkkA28g5o/edit#slide=id.p',
    ...
    this.loadData = function () {
      console.log(
        `Officer Tools Current User: ${ctl.currentuser}, ${ctl.sessionID}`
      )
    }
    ...
    this.exportDoorCodes = function () {
      ...
      ctl.setError('')
      $http
        .post(urls.exportExpiredCodes, requestBody, config)
        .then(response => {
