...
export function xMark () {
  return (
    <svg width='24' height='24' viewBox='0 0 24 24' style={{ fill: 'RED' }}>
      <path
        d='M24 20.188l-8.315-8.209 8.2-8.282-3.697-3.697-8.212 8.318-8.31-8.203-3.666
...
export function editSymbol () {
  return (
    ...
    20.42,11.3L21.7,12.58C21.91,12.79 21.91,13.14 21.7,13.35M12,18.94L18.06,12.88L20.11,14.93L14.06,
    21H12V18.94M12,14C7.58,14 4,15.79 4,18V20H10V18.11L14,14.11C13.34,14.03 12.67,14 12,14M12,4A4,4
...
export function cancelEditSymbol (callDatabase, setToggle) {
  return (
    ...
    >
      <path
        d='M24 20.188l-8.315-8.209 8.2-8.282-3.697-3.697-8.212 8.318-8.31-8.203-3.666 3.666 8.321
