...
export default function Printing(props) {
  ...
  async function getNumberOfPagesPrintedSoFar() {
    const result = await getPagesPrinted(props.user.email, props.user.token);
  ...
  useEffect(() => {
    if (previewDisplay) {
      ...
      const pagesUsedPerCopy =
        Math.floor(numberOfPagesInPdfPreview / divisor) +
        (numberOfPagesInPdfPreview % divisor);
          ...
          <div className="h-auto mt-10 ml-10 lg:col-span-2 lg:mt-0">
            ...
            <div className="grid grid-cols-1">
                ...
                <div id="">
                  ...
                  <div className="mt-2">
                    <select
                      id="sides"
                      name="sides"
                      className="block w-full py-2 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                      onChange={(e) => {
              ...
              <div className="mt-3 mb-6 ">
                <PageSelectDropdown setPageRanges={setPageRanges} />
              </div>
              <div className="space-x-5 ">
                ...
                <button className="w-3/12 btn btn-outline" onClick={clearPrint}>
                  Cancel
                </button>
                <button
                  ...
                  disabled={
                    !pagesToBeUsedInPrintRequest || requestExceedsAllowedPages()
                  }
                >
                  Print
                </button>
      ...
      return (
        <div className="flex items-center justify-center w-full mt-10">
          <div role="alert" className="w-1/2 text-center alert alert-error">
            ...
            <p className="">
              Printing is down. Reach out to SCE Development team if refreshing
              doesn't fix
            </p>
          </div>
        </div>
    ...
    return (
      <div className="flex flex-col items-center w-full">
        <div className="mx-12 mb-10">
          <span className="flex items-center justify-center mb-5 text-3xl">
          ...
          <ol className="list-decimal">
            ...
            <li>
              printed documents can be found in in the SCE room (ENGR 294).
            </li>
          </ol>
        </div>
        <form
