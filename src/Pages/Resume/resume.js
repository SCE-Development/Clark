...
class Resume extends Component {
  constructor(props) {
    ...
    this.state = {
    projectInfo: [{projectName: "", projectLocation: "", projectToolsUsed: "", 
                     projectStartDate: "", projectEndDate: "", projectDescription1: "", 
                     projectDescription2: "", projectDescription3: "",}],
    experienceInfo: [{organizationName: "", positionTitle: "", experienceLocation: "", 
...
handleChange(event){
  ...
  addProject = (e) =>{
     this.setState((prevState) =>({
      projectInfo: [...prevState.projectInfo, {projectName: "", projectLocation:"", projectToolsUsed: "", 
                      projectStartDate: "", projectEndDate: "", projectDescription1: "", 
                      projectDescription2: "", projectDescription3: ""}],
     }));
  ...
  addExperience= (e) =>{
     this.setState((prevState) =>({
      experienceInfo: [...prevState.experienceInfo, {organizationName: "", positionTitle: "", experienceLocation: "", 
                     experienceStartDate: "", experienceEndDate: "", experienceDescription1: "", 
                     experienceDescription2: "", experienceDescription3: ""}],
     }));
    ...
    return (
      ...
      experienceInfo.map((val, idx) =>{    
       ...
       return (
         <Experience
         id = {idx}
         organizationName = {this.state.experienceInfo[idx].organizationName}
         positionTitle = {this.state.experienceInfo[idx].positionTitle}
         experienceLocation = {this.state.experienceInfo[idx].experienceLocation}
         experienceStartDate = {this.state.experienceInfo[idx].experienceStartDate}
         experienceEndDate = {this.state.experienceInfo[idx].experienceEndDate}
         experienceDescription1 = {this.state.experienceInfo[idx].experienceDescription1}
         experienceDescription2 = {this.state.experienceInfo[idx].experienceDescription2}
         experienceDescription3 = {this.state.experienceInfo[idx].experienceDescription3}
