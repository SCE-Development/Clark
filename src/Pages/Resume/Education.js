      ...
      <div>
        ...
        <FormGroup>
          ...
          <Input
            ...
            name = 'titleMajor'
            type='text'
            value = {this.props.titleMajor}
            onChange = {this.props.handleChange}
            placeholder='Type Title and Major Here' />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange = {this.props.handleChange}
            placeholder='Type Cumulative GPA Here' />
        </FormGroup>
        <FormGroup>
          ...
          <Input
            ...
            type='text'
            value = {this.props.relevantCoursework}
            onChange = {this.props.handleChange}
            placeholder='Type Relevant Coursework Here' />
        </FormGroup>
      </div>
    );
  }
