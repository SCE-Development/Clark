...
class MembershipPlan extends Component{
 ...
 getBody(title){
  if(title === "Full Year (2019-2020)"){
    return <h6 style={{margin:5}}>Access to our club room during legal building hours.
    Access to our events and news.
    And much more!
    This membership lasts a full year and expires on May 20th, 2020.
    Sign Up @ SCE (ENGR 294) </h6>

  }
  return  <h6 style={{margin:5}}  >Access to our club room during legal building hours.
  Access to our events and news.
  And much more!
  This membership lasts a semester   and expires on December 20nd, 2019.
  Sign Up @ SCE (ENGR 294)</h6>
