    ...
    <div className='text-center overview-container bg-gray min-h-[100dvh]'>
      ...
      <div className='flex flex-col items-center text-black dark:text-white'>
        ...
        <div className='max-w-full flex flex-col justify-center items-center'>
          <div className='max-w-[1150px] max-h-[1050px] overflow-hidden inline-block scale-50 origin-top border-[6px] border-red-500 dark:border-white'>
            <iframe
              id='led-frame'
              src='http://192.168.69.123:8888'
              title='LED Emulator'
              className='w-[1150px] h-[1050px]'
              scrolling='no'
            />
          </div>
        </div>
