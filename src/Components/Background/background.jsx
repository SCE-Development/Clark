...
export default function background(props) {
    ...
    var circleRadius = props.size * 0.0035;
            ...
            <svg width={props.size} height={props.size} viewBox={`0 0 ${props.size} ${props.size}`} fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <g transform={`translate(${props.size / 2}, ${props.size / 2})`}>
                        ...
                        <g>
                            <circle cx={lineEnd + circleRadius} cy={-lineMid - spread} r={circleRadius} stroke="#B8B8B8" strokeWidth={props.size * 0.002}/>
                            <circle cx={lineEnd + circleRadius} cy={-lineMid + spread} r={circleRadius} stroke="#B8B8B8" strokeWidth={props.size * 0.002}/>
                            
                            <circle cx={lineEnd + circleRadius} cy={lineMid - spread} r={circleRadius} stroke="#B8B8B8" strokeWidth={props.size * 0.002}/>
                            <circle cx={lineMid - spread} cy={lineEnd + circleRadius} r={circleRadius} stroke="#B8B8B8" strokeWidth={props.size * 0.002}/>
